...
/* we count using these variables */

__device__ int* d_ngs_type_A;
__device__ int* d_ngs_type_B;
...
__device__ Pt pairwise_force(Pt Xi, Pt r, float dist, int i, int j)
{
    ...
    /* we count here, during the pairwise interactions */
